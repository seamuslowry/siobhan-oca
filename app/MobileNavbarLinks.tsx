  ...
  return (
    <>
      ...
      <dialog
        ...
        onClose={handleClose}
        onClick={handleClick}
        className="backdrop:bg-gray-100/50 fixed top-0 left-full m-0 p-0 w-full max-w-xs h-screen max-h-screen bg-gray-800 text-white shadow-lg rounded-l-lg flex flex-col z-50 transition-transform open:-translate-x-full"
      >
